...
def ZScaler_test2(test_data, zfit, n) :
    zdata = zfit.transform(test_data)
    zdata = zdata * np.sqrt((n-1)/n)
    return zdata
...
ZX_train2, zfit_train, n_train = ZScaler2(X_train)
ZX_test2 = ZScaler_test2(X_test, zfit_train, n_train)
